  ...
  <div class="wrapper">
    <Form :validation-schema="productform" @submit="submitproduct">
      ...
      <div class="form-group">
        ...
        <Field type="text" class="form-control" id="sizeproduct" name="size" placeholder="Enter product size"
          v-model="productLocal.size" />
        <ErrorMessage name="size" class="text-danger" />
      </div>
      <div class="form-group">
        <label for="colorproduct">Color</label>
        <Field type="text" class="form-control" id="colorproduct" name="color" placeholder="Enter product color"
